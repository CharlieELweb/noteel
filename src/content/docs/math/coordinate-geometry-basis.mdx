...
To find the slope of line, we need transform it to the form like $y=mx+b$ (slope-intercept form).
...
#### Find the equation of the line which is parallel to line $L_1: y=5x+4$ and cuts the $y$-axis at $A(0, 2)$.

The equation of the line is: $y=$ <Blank number answer="5" /> $x+$ <Blank number answer="2" />

</Question>

<Question>

#### Find the equation of the line passing through $A(3, 5)$ and $B(1, -2)$.

The equation of the line is: <Blank number answer="7" /> $x+$ <Blank number answer="-2" /> $y+$ <Blank number answer="-4" /> $=0$

</Question>

<Question>

#### Find the equation of the line which passes through the point $A(−6, 1)$ and is perpendicular to the line $L_1: 5x+3y-7=0$.

The equation of the line is: <Blank number answer="-3" /> $x+$ <Blank number answer="5" /> $y+$ <Blank number answer="-23" /> $=0$
